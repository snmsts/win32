...
;; ChooseFont Dialog Box Support

(defwin32struct choosefont
  (struct-size dword)
  (hwnd-owner hwnd)
  (hdc hdc)
  (log-font (:pointer logfont))
  (point-size int)
  (flags dword)
  (rgb-colors dword)
  (cust-data lparam)
  ...
  (style :pointer)
  (font-type word)
  (missing-alignment word)
  (size-min int)
  (size-max int))

(defwin32fun ("ChooseFontW" choose-font comdlg32) bool
  (cf (:pointer choosefont)))
(defwin32constant +cf-screenfonts+ #x00000001)
(defwin32constant +cf-printerfonts+ #x00000002)
(defwin32constant +cf-both+ #x00000003)
(defwin32constant +cf-showhelp+ #x00000004)
(defwin32constant +cf-enablehook+ #x00000008)
(defwin32constant +cf-enabletemplate+ #x00000010)
(defwin32constant +cf-enabletemplatehandle+ #x00000020)
(defwin32constant +cf-inittologfontstruct+ #x00000040)
(defwin32constant +cf-usestyle+ #x00000080)
(defwin32constant +cf-effects+ #x00000100)
(defwin32constant +cf-apply+ #x00000200)
(defwin32constant +cf-ansionly+ #x00000400)
(defwin32constant +cf-novectorfonts+ #x00000800)
(defwin32constant +cf-nooemfonts+ #x00000800)
(defwin32constant +cf-nosimulations+ #x00001000)
(defwin32constant +cf-limitsize+ #x00002000)
(defwin32constant +cf-fixedpitchonly+ #x00004000)
(defwin32constant +cf-wysiwyg+ #x00008000)
(defwin32constant +cf-forcefontexist+ #x00010000)
(defwin32constant +cf-scalableonly+ #x00020000)
(defwin32constant +cf-ttonly+ #x00040000)
(defwin32constant +cf-nofacesel+ #x00080000)
(defwin32constant +cf-nostylesel+ #x00100000)
(defwin32constant +cf-nosizesel+ #x00200000)

(defwin32constant +screen-fonttype+ #x0001)
(defwin32constant +printer-fonttype+ #x0002)
(defwin32constant +stc1+ #x0440)
(defwin32constant +stc2+ #x0441)
(defwin32constant +stc3+ #x0442)
